...
const Footer: React.FC = () => {
  ...
  const buttons = [
    {
      link: "https://www.linkedin.com/in/hye-soo-park-785844242/",
      title: "LinkedIn"
    }, {
      link: "mailto:hyehye@kaist.ac.kr",
      title: "Email"
    }, {
      link: "https://twitter.com/HyeSPark07?s=20&t=HhxT7YxGlyINJPoDcDRSbw",
      title: "Twitter"
    }, {
      link: "/data/CV.pdf",
      title: "CV"
  ...
  return (
    <footer className="border-t border-gray-300 p-6 md:p-12 mt-16">
      <div className="text-main_color dark:text-main_color_dark text-2xl font-bold mb-4">Contact</div>
