...
from: "2022-06"
to: "2022-06"
thumb: "/img/proj_voura_1.jpg"
---

## 📝 About the Project

![Voura Prototype Hyesoo Park KAIST Group 7.jpg](/img/proj_voura_1.jpg)

> **Design project** from [**HACKAIST** — Design hackathon of KAIST & Imperial College London](https://hackaist.com)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        lower <em>maxFreq</em> → more saturated color
      </td>
    </tr>
    <tr>
      <td>Intonation</td>
      <td>Range of size</td>
      <td>
        larger range of <em>maxFreq</em> → larger range of size
      </td>
    </tr>
    <tr>
      <td>Volume</td>
      <td>Evg. size</td>
      <td>
        larger average of <em>maxFreq</em> → larger size
      </td>
    </tr>
  </tbody>
</table>
...
- _maxFreq_ = the frequency level that has maximum volume in FFT result
