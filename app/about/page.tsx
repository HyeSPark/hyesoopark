      ...
      <article className="py-6 prose dark:prose-invert">
        ...
        <div className="flex flex-wrap gap-3 text-lg">
            ...
            <a target="_blank" className="flex rounded-full px-4 py-2 border gap-2 items-center" href="https://www.behance.net/hayespark">
                <Behance /><span>Design Projects</span>
            </a>
        ...
        <ul>
            ...
            <li>Mar. 2018 - Aug. 2022: B.E. in Industrial & Systems Engineering, KAIST
                <ul>
                    <li>Double major in Industrial Design, Graduated <em>Magma Cum Laude</em></li>
                </ul>
            </li>
        </ul>
        ...
        <ul>
          ...
          <li>React.js, Next.js — Developing web app using components and hooks</li>
        ...
        <ul>
          <li>Using Adobe Creative Suite - Photoshop, Illustrator, After Effect, etc.</li>
        </ul>
